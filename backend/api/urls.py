...
from .admin_views import AdminDashboardView, DeleteUserView
...
urlpatterns = [
    ...
    path("admin/delete-user/<int:user_id>/", DeleteUserView.as_view(), name="admin_delete_user"),
    path("admin/meal-plans/", AdminMealPlanView.as_view(), name="admin_meal_plans"),
]
